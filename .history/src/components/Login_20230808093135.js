    ...
    <>
      <Card className="shadow p-3 mb-5 bg-dark text-white rounded p-3 mb-2">
        <Card.Body>
          ...
          <p className="text-center"> Faça seu login e Crie sua conta PIX.
            Simples rápido e fácil. Caso não tenha.
            <Link className="btn btn-link" to="/signup">Click aqui</Link>e criar uma.
          </p>
